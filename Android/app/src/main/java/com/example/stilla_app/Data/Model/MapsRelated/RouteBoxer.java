...
/**
 * EXAMLPE USAGE FOR JAVASCRIPT: https://github.com/denissellu/routeboxer/blob/master/example/routeboxer-v3.html
 * COULD BE HELPFUL
 * DOCUMENTATION: http://www.griffons.pl/mapy/routeboxer/docs/examples.html
 */
public class RouteBoxer {
     ...
     * helga
     */
    public List<com.google.android.gms.maps.model.LatLng> rboxerlltogooglell(List<LatLng> latLng) {
        int n = latLng.size();
        List<com.google.android.gms.maps.model.LatLng> googleList = new ArrayList<>();

        for (int i=0; i<n; i++){
            double currLat = latLng.get(i).lat;
            double currLng = latLng.get(i).lng;

            googleList.add(new com.google.android.gms.maps.model.LatLng(currLat,currLng));
        }
